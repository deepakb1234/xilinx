...
set X_JAVA_HOME="%parent%\tps\win64\jre9.0.4"
...
IF "%XIC_CLASS_PATH%" == "" (
  set X_CLASS_PATH=%parent%\lib\classes\json-simple-1.1.1.jar;%parent%\lib\classes\httpclient-4.2.5.jar;%parent%\lib\classes\httpcore-4.2.4.jar;%parent%\lib\classes\commons-logging-1.1.1.jar;%parent%\lib\classes\xinstaller.jar;%parent%\lib\classes\log4j-1.2.15.jar;%parent%\lib\classes\sevenzipjbinding-AllWindows.jar
) ELSE (
